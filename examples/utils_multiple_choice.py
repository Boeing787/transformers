        ...
        for (i, line) in enumerate(lines):
            ...
            examples.append(
                InputExample(
                    example_id=guid,
                    question=response,
                    contexts=[parent, parent, parent, parent],
                    endings=[cc0, cc1, cc2, cc3],
                    label=label
                )
            )
        return examples

############################# END PROCESSOR FOR THREADDIT
...
processors = {"race": RaceProcessor, "swag": SwagProcessor, "arc": ArcProcessor, "threaddit": ThredditProcessor}


MULTIPLE_CHOICE_TASKS_NUM_LABELS = {"race", 4, "swag", 4, "arc", 4, "threaddit", 4}
